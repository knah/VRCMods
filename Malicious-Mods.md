...
Do you consider yourself an evil person? If so, try to become a better person instead of sticking to your existing ways - everyone is capable of self-improvement, and you'll be better off as a result.  
...
Which world do you want to live in? One where every mod user has to fear bans due to modding being unwelcome, and public instances are unusable? Or one where modding is accepted, carries no risk of punishment, and no trolls are running around publics with their orbiting pickups? Don't be complacent, take action!
